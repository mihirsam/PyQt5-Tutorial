from PyQt5.QtWidgets import QFontDialog, QTextEdit, QAction, QMainWindow, QMenuBar, QWidget, QToolBox, QFormLayout, QScrollArea, QSlider, QSplitter, QFrame, QSizeGrip, QRadioButton, QButtonGroup, QLineEdit, QApplication, QPushButton, QLabel, QDialog, QGroupBox, QHBoxLayout, QVBoxLayout, QGridLayout, QCheckBox
import sys
...
class Window(QMainWindow):
    ...
    def CreateMenu(self):
        ...
        colorAction = QAction(QIcon(self.IconName), "Font", self)
        colorAction.setShortcut("Ctrl+F")
